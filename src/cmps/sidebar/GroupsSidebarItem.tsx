...
export default function SidebarItem({
  ...
  const getID = matchPath(path, location.pathname)
    ? "groups-sidebar-item-active"
    : "";

  return (
    <li
      className="groups-sidebar-item-container"
      id={getID}
      onClick={() => navigate(path)}
    >
      <div
        className="groups-sidebar-activated-item-highlight"
        id={"highlight-" + getID}
      ></div>
